...
class StudentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Student entity")
        ...
        .repeat(2) {
            ...
            .post("/api/students")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "dob":"2020-01-01T00:00:00.000Z", "gender":"SAMPLE_TEXT", "contactNo":"SAMPLE_TEXT", "age":"0", "parentFirstName":"SAMPLE_TEXT", "parentLastName":"SAMPLE_TEXT", "highRiskTag":"SAMPLE_TEXT", "studentClass":"SAMPLE_TEXT", "division":"SAMPLE_TEXT", "status":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
